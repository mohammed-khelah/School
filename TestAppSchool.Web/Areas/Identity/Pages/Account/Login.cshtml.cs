...
namespace TestAppSchool.Web.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(TestAppSchoolDbContext db, SignInManager<User> signInManager, ILogger<LoginModel> logger)
        {
            _db = db;
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = _db.Users.SingleOrDefault(x => x.Email == Input.Email && !x.IsDelete);
                if (user != null)
                {
